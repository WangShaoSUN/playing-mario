...
parser.add_argument('--games', type=str, default="dqn_mario", help='name of the games. for example: Breakout')
...
parser.add_argument('--targ_freq',type=int, default=5, help='seed of the games')
...
PRED_PATH = './data/model1/dqn_pred_net_o_' + args.games + '.pkl'
TARGET_PATH = './data/model1/dqn_target_net_o_' + args.games + '.pkl'
RESULT_PATH = './data/plots1/dqn_result_o_' + args.games + '.pkl'
